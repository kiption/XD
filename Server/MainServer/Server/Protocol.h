...
enum PacketID {
	...
	, CS_LOGIN, CS_MOVE, CS_ROTATE, CS_ATTACK, CS_INPUT_KEYBOARD, CS_INPUT_MOUSE, CS_CHAT, CS_PARTICLE_COLLIDE, CS_PING, CS_RELOGIN
...
// 4) UI 관련 패킷
#define STAGE1_TIMELIMIT 60 // 스테이지1 제한시간 (단위: sec)
