...
enum PacketID {
	CLGN_LOGIN_REQUEST
	, LGNC_LOGIN_RESULT
	, CLBY_CONNECT, CLBY_CREATE_ROOM, CLBY_QUICK_MATCH, CLBY_LEAVE_ROOM, CLBY_ROLE_CHANGE, CLBY_GAME_READY, CLBY_GAME_START
	, LBYC_MATCH_FAIL, LBYC_ROOM_JOIN, LBYC_ADD_ROOM, LBYC_ROOM_USERCOUNT, LBYC_ROOM_NEW_MEMBER, LBYC_ROOM_LEFT_MEMBER
	, LBYC_LOBBY_CLEAR, LBYC_MEMBER_STATE, LBYC_ROLE_CHANGE, LBYC_GAME_START, LBYC_POPUP
	...
	, SC_DAMAGED, SC_ATTACK, SC_RELOAD, SC_CHANGE_SCENE, SC_OBJECT_STATE, SC_RESPAWN, SC_TIMEOUT, SC_GAMEOVER, SC_BULLET_COLLIDE_POS, SC_MISSION, SC_MISSION_COMPLETE
...
// 4) UI 관련 패킷
#define STAGE1_TIMELIMIT 440 // 스테이지1 제한시간 (단위: sec)
