...
{
	float  							m_fTime = 0.0f;
	const wchar_t* m_pCallbackData = NULL;
};
...
public:
	virtual void HandleCallback(const wchar_t* pCallbackData) { }
};
...
public:
	...
	void SetCallbackKey(int nKeyIndex, float fTime, const wchar_t* pData);
	void SetAnimationCallbackHandler(CAnimationCallbackHandler* pCallbackHandler);

	const wchar_t* GetCallbackData();
};
...
public:
	...
	void SetCallbackKey(int nAnimationSet, int nKeyIndex, float fTime, const wchar_t* pData);
...
public:
	...
	void SetCallbackKey(int nSkinnedMesh, int nAnimationSet, int nKeyIndex, float fTime, const wchar_t* pData);
...
public:
	...
	void SceneModelRender(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera = NULL);
...
public:
	...
	static CGameObject* LoadModelGeometryFromFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, const char* pstrFileName, CShader* pShader);
