...
void CScene::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	XMFLOAT3 xmf3Scale(18.0f, 8.5f, 18.0f);
	XMFLOAT4 xmf4Color(0.0f, 0.5f, 0.0f, 0.0f);
	m_pTerrain = new CHeightMapTerrain(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, _T("Image/Terrain/HeightMap.raw"), 257, 257, 257, 257, xmf3Scale, xmf4Color);
	...
	m_pUseWaterMove = new CUseWaterMoveTerrain(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, _T("Image/Terrain/waterterrain8bit.raw"), 257, 257, 8, 8, xmf4ScaleW, xmf4ColorW);
	...
	pMultiSpriteObjectShader->BuildObjects(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, m_pTerrain);
...
void CScene::AnimateObjects(float fTimeElapsed)
{
	...
	for (int j = 0; j < BULLETS; j++)
	{
		for (int i = 0; i < 10; i++) {
			...
			{
				m_ppShaders[0]->m_ppObjects[i]->SetScale(0.0f, 0.0f, 0.0f);
				CollisionCheck = i;
				ppBullets[j]->Reset();
			}
		}
