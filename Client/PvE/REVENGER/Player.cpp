...
CAirplanePlayer::CAirplanePlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, void *pContext)
{
	...
	m_pTailRotorFrame=new CGameObject();
	pAngrybotModel = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, "Model/HeliPlayer.bin", NULL);
	SetChild(pAngrybotModel->m_pModelRootObject, true);
	m_pTailRotorFrame = pAngrybotModel->m_pModelRootObject->FindFrame("military helicopter_blades");
...
{
	m_pTailRotorFrame = FindFrame("military helicopter_blades");
