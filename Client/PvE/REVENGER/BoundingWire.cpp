...
D3D12_INPUT_LAYOUT_DESC BoundingWireShader::CreateInputLayout(int nPipelinestates)
{
...
D3D12_RASTERIZER_DESC BoundingWireShader::CreateRasterizerState(int nPipelinestates)
{
...
D3D12_DEPTH_STENCIL_DESC BoundingWireShader::CreateDepthStencilState(int nPipelinestates)
{
