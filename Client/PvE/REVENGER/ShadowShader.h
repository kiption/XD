...
class CAnimationShadowMapShader : public CShader
{
public:
	CAnimationShadowMapShader(CObjectsShader* pObjectsShader);
	virtual ~CAnimationShadowMapShader();
	virtual D3D12_INPUT_LAYOUT_DESC CreateInputLayout(int nPipelineState);
	virtual D3D12_DEPTH_STENCIL_DESC CreateDepthStencilState(int nPipelineState);
	virtual D3D12_RASTERIZER_DESC CreateRasterizerState(int nPipelineState);
	virtual D3D12_SHADER_BYTECODE CreateVertexShader(ID3DBlob** ppd3dShaderBlob, int nPipelineState);
...
class CAnimationDepthRenderShader : public CShader
{
public:
	CAnimationDepthRenderShader(CObjectsShader* pObjectsShader, LIGHT* pLights);
	virtual ~CAnimationDepthRenderShader();
