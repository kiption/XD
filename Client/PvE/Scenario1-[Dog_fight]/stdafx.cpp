...
ID3D12RootSignature* GraphicsRootSignatureSt1(ID3D12Device* pd3dDevice)
{
	ID3D12RootSignature* pd3dGraphicsRootSignature = NULL;

#ifdef _WITH_STANDARD_TEXTURE_MULTIPLE_DESCRIPTORS
	D3D12_DESCRIPTOR_RANGE pd3dDescriptorRanges[21];
	...
	pd3dDescriptorRanges[18].BaseShaderRegister = 27; ///t27
...
ID3D12RootSignature* GraphicsRootSignatureSt2(ID3D12Device* pd3dDevice)
{
	ID3D12RootSignature* pd3dGraphicsRootSignature = NULL;
	...
	pd3dRootParameters[19].Descriptor.ShaderRegister = 7; //Material
