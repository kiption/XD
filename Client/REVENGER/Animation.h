...
public:
	...
	GameObjectMgr** m_ppAnimatedBoneFrameCaches = NULL; //[m_nAnimatedBoneFrames]
};
...
public:
	...
	GameObjectMgr* m_pModelRootObject = NULL;
...
public:
	...
	void AdvanceTime(float fElapsedTime, GameObjectMgr* pRootGameObject);

public:
	bool							m_bRootMotion = false;
	GameObjectMgr* m_pModelRootObject = NULL;

	GameObjectMgr* m_pRootMotionObject = NULL;
	...
	virtual void OnRootMotion(GameObjectMgr* pRootGameObject) { }
	virtual void OnAnimationIK(GameObjectMgr* pRootGameObject) { }
};
