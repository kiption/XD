...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
	...
	::LoadString(hInstance, IDC_REVENGER, szWindowClass, MAX_LOADSTRING);
	MyRegisterClass(hInstance);

	if (!InitInstance(hInstance, nCmdShow)) return(FALSE);

	hAccelTable = ::LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_REVENGER));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = ::LoadIcon(hInstance, MAKEINTRESOURCE(IDI_REVENGER));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	HWND hMainWnd = CreateWindow(szWindowClass, L"REVENGER", dwStyle, CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, NULL, NULL, hInstance, NULL);
